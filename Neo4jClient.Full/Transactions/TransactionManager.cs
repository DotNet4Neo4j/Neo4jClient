...
namespace Neo4jClient.Transactions
{
	...
	internal class TransactionManager : ITransactionManager
	{
		...
		internal static AsyncLocal<Stack<TransactionScopeProxy>> ScopedTransactions
		{
			get
			{
		...
		//internal Stack<TransactionScopeProxy>  ScopedTransactions {  get { return scopedTransactions.Value; } set { scopedTransactions.Value = value; } }
		...
		private static AsyncLocal<Stack<TransactionScopeProxy>> GetNewScopedTransactions()
		{
		...
		public TransactionScopeProxy CurrentInternalTransaction
		{
			get
			{
				if (ScopedTransactions == null || ScopedTransactions.Value.Count == 0)
					return null;
