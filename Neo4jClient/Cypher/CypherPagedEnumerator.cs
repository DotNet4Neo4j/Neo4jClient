...
{
    internal class CypherPagedEnumerator<TResult> : IEnumerator<TResult>
    {
        readonly Func<ICypherQuery, IEnumerable<TResult>> pageLoadCallback;
        readonly ICypherQuery query;
        ...
        public CypherPagedEnumerator(
            Func<ICypherQuery, IEnumerable<TResult>> pageLoadCallback,
            ICypherQuery query,
            int pageSize = 100)
        {
