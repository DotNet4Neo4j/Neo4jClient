...
namespace Neo4jClient.Test.GraphClientTests
{
    ...
    public class GetNodeTests
    {
        ...
        [Test]
        public void ShouldReturnNodeDataWhenGetAllDataCalled()
        {
            var httpFactory = MockHttpFactory.Generate("http://foo/db/data", new Dictionary<RestRequest, HttpResponse>
            {
                 {
                    ...
                    new HttpResponse
                    {
                        ...
                        Content = @"{
                          ...
                          'extensions' : {
                            'CustomNeo4JPlugin' : {
                              'get_all_nodes' : 'http://foo/db/data/ext/GetAll/graphdb/get_all_nodes'
                             }
                          }
                        }".Replace('\'', '"')
                    }
...

                {
                    ...
                    new RestRequest {
                        Resource = "/ext/GetAll/graphdb/get_all_nodes",
                        Method = Method.POST,
            ...
            var nodes = graphClient.GetAllNodesFromDatabase<TestNode>().ToList();
